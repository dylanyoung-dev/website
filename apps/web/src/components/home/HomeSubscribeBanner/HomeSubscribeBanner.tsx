...
/**
 * Native homepage subscribe block (hardcoded copy).
 * AmplifyUP Composer uses `SubscribeBanner` placeable instead.
 */
export function HomeSubscribeBanner({ className }: { className?: string }) {
