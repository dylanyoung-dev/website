...
import { ArrowRight, BookOpen, Briefcase, FileText, Home, Mic, Search, User, Video } from 'lucide-react';
...
export default function NotFound() {
    ...
    return (
        <Layout metaTitle="404 - Page Not Found" metaDescription="The page you are looking for could not be found.">
            <div className="container mx-auto px-4 py-12 md:py-24 max-w-4xl">
                <div className="flex flex-col items-center justify-center text-center space-y-8">
                    {/* 404 Number */}
                    <div className="space-y-4">
                        <h1 className="text-8xl md:text-9xl font-bold text-primary/20 dark:text-primary/30">404</h1>
